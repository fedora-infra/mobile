...
trait NavDrawerActivity extends FragmentActivity with TypedActivity {
  ...
  lazy val navMap = Map(
    ...
    getString(R.string.badges_leaderboard) -> (classOf[BadgesLeaderboardActivity], R.drawable.ic_fedocal),
    getString(R.string.fedmsg_gcm_demo) -> (classOf[GCMDemoActivity], R.drawable.ic_fedmsg),
    getString(R.string.preferences) -> (classOf[PreferencesActivity], R.drawable.ic_fedocal)
  )
